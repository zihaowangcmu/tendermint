...
require (
	...
	github.com/GaijinEntertainment/go-exhaustruct/v2 v2.2.1 // indirect
	...
	github.com/bazelbuild/bazel-gazelle v0.26.0 // indirect
	...
	github.com/curioswitch/go-reassign v0.1.1 // indirect
